...
- Eloquent related method `getKey` & `getMorphClass` added to `Igorsgm\Likeable\Contracts\Likeable` contract
- `collectLikers`, `collectDislikers` & `scopeOrderByDislikesCount` methods added to `Igorsgm\Likeable\Contracts\Likeable` contract
- `collectLikersOf` & `collectDislikersOf` methods to `Igorsgm\Likeable\Contracts\LikeableService` contract

### Changed

- `Igorsgm\Likeable\Contracts` contract renamed to `Igorsgm\Likeable\Contracts\Likeable`
- `Igorsgm\Likeable\Traits\HasLikes` trait renamed to `Igorsgm\Likeable\Traits\Likeable`
