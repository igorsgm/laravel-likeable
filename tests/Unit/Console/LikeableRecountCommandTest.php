...
use Igorsgm\Likeable\Tests\Stubs\Models\EntityWithMorphMap;
 ...
 *
 * @package Igorsgm\Likeable\Tests\Unit\Console
 */
class LikeableRecountCommandTest extends TestCase
{
    ...
    public function it_can_throw_model_invalid_exception_on_not_exist_morph_map()
    {
        ...
        $this->expectException(\Igorsgm\Likeable\Exceptions\ModelInvalidException::class);
        ...
        //$this->assertContains('Igorsgm\Likeable\Exceptions\ModelInvalidException', $output->fetch());
    }
